...
Instead of reviewing all of the script files in this repository (which are described below), you can look go to http://htmlpreview.github.io/?https://github.com/lisahuang2/housing_data_ML/blob/master/king_county_markdown.html to view a short report of my work. You can also open the "king_county_markdown_report.pdf" document to see the same content in pdf format. This report was created with R Markdown. You can see the markdown code in the file called "king county markdown.rmd".      
